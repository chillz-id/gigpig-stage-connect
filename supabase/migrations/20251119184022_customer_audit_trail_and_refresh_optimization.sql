-- Migration: Customer Data Audit Trail & Refresh Optimization
-- Created: 2025-11-19
-- Purpose: Fix refresh_customer_engagement_metrics to only update changed rows
--          and implement comprehensive audit logging for customer data changes

-- ============================================================================
-- PART 1: Create Audit Log Infrastructure
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_audit_logs_changed_by ON public.audit_logs(changed_by) WHERE changed_by IS NOT NULL;
...
'Generic audit trigger function that logs all changes to tables with who, what, when, and why context';

-- ============================================================================
-- PART 2: Optimize Refresh Function
-- ============================================================================
...
-- ============================================================================
-- PART 3: Optimize Trigger Cascade
-- ============================================================================
...
COMMENT ON VIEW public.customer_profile_changes IS
'Shows detailed change history for customer profiles with user attribution';
...
COMMENT ON VIEW public.cron_job_impact IS
'Analyzes the impact of scheduled cron jobs on database tables';
