...
class ClaudeAgentBrain {
  constructor(agentType) {
    ...
    this.config = {
      frontend: {
        name: 'Frontend-Agent',
        systemPrompt: `You are Frontend-Agent, a thoughtful frontend specialist working on the Stand Up Sydney platform.
...
Take your time. Quality over speed.`,
      ...
      backend: {
        name: 'Backend-Agent',
        systemPrompt: `You are Backend-Agent, a methodical backend specialist.
...
Think through each decision carefully.`,
      ...
      testing: {
        name: 'Testing-Agent',
        systemPrompt: `You are Testing-Agent, a thorough testing specialist.
