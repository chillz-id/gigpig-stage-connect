              ...
              <div className={cn(
                ...
                <Button
                  onClick={() => {
                    ...
                    navigate(slug ? `/photographer/${slug}/edit` : '/profile');
                  }}
                ...
                <Button
                  onClick={() => {
                    const slug = profile?.profile_slug || profile?.id;
                    navigate(slug ? `/photographer/${slug}/edit?tab=calendar` : '/profile?tab=calendar');
                  }}
                  className="professional-button w-full justify-start touch-target-44"
                  size={isMobile ? "mobile" : "default"}
                >
                ...
                <Button
                  onClick={() => {
                    const slug = profile?.profile_slug || profile?.id;
                    navigate(slug ? `/photographer/${slug}/edit?tab=invoices` : '/profile?tab=invoices');
                  }}
                  className="professional-button w-full justify-start touch-target-44"
                  size={isMobile ? "mobile" : "default"}
                >
