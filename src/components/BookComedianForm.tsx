...
export const BookComedianForm: React.FC = () => {
  const { user } = useUser();
  ...
  const [specificComedian, setSpecificComedian] = useState('');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const requestData = {
      ...
      requested_comedian_id: requestType === 'specific' && specificComedian ? specificComedian : undefined,
