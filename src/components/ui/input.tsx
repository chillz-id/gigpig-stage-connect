  ...
  ({ className, type, ...props }, ref) => {
    ...
    return (
      <input
        type={type}
        className={cn(
          "flex h-8 w-full rounded-lg px-3 py-0.5 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground focus-visible:outline-none focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200",
          getThemeStyles(),
          className
        )}
        ref={ref}
