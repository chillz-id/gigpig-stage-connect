...
export function useEvents(filters?: {
  ...
  const publishEvent = async (eventId: string) => {
    const response = await eventsApi.updateStatus(eventId, 'open');
    if (response.error) throw response.error;
    crud.refetch();
    refetchDetails();
    return response.data;
  ...
  const closeEvent = async (eventId: string) => {
    const response = await eventsApi.updateStatus(eventId, 'closed');
    if (response.error) throw response.error;
    crud.refetch();
    refetchDetails();
    return response.data;
  ...
  const cancelEvent = async (eventId: string) => {
    const response = await eventsApi.updateStatus(eventId, 'cancelled');
    if (response.error) throw response.error;
    crud.refetch();
    refetchDetails();
    return response.data;
