...
export const useProfileOperations = () => {
  ...
  const fetchProfile = useCallback(async (userId: string) => {
    try {
      ...
      // If multiple profiles exist (data will be null in this case), try to get just one
      if (!data) {
        console.log('No profile found or multiple profiles exist, attempting to get first profile...');
